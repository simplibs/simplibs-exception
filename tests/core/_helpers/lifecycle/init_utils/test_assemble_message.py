from simplibs.exception.core._helpers.lifecycle.init_utils.assemble_message import (
    assemble_message,
)
...
def test_module_imports_cleanly_without_triggering_circular_loops():
    ...
    module_path = "simplibs.exception.core._helpers.lifecycle.init_utils.assemble_message"
