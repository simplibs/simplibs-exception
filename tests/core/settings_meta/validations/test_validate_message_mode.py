...
from simplibs.exception.core._settings_meta.validations.validate_message_mode import validate_message_mode
...
def test_custom_mode_instance_passes():
    ...
    from simplibs.exception.modes.mode_base import ModeBase
