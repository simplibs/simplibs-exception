...
# Inners
from ._helpers.settings_meta import SettingsMeta
from ._helpers.internal_exceptions import SimpleExceptionSettingsError
# Annotations
if TYPE_CHECKING:
...
class SimpleExceptionSettings(metaclass=SettingsMeta):
    ...
    def reset(cls) -> None:
        ...
        cls.GET_LOCATION = 1
        cls.LOCATION_BLACKLIST = cls._SYSTEM_BLACKLIST
...
- `"simplibs/"`: Automatically suppresses internal execution noise from every simplibs library, not just this one.
