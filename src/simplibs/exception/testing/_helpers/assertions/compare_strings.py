def compare_strings(
    test_value: str | tuple[str, ...] | None,
    exc_value: str | tuple[str, ...] | None,
    *,
    exact_match: bool,
) -> None:
    ...
    raw_test = test_value if test_value is not None else ""
    raw_exc = exc_value if exc_value is not None else ""
