...
class OnelineMessage(ModeBase):
    ...
    def empty_outcome(
        ...
        """
        return f"{print_intro_line(data)} | {print_caller_info(data)}"
    ...
    def message_outcome(
        ...
        """
        return f"{print_intro_line(data)}: {data.message} | {print_caller_info(data)}"
