...
**Komplexní audit funkční logiky**

`assert_exception_function` je hlavní orchestrátor (vzorec **Facade**) testovací infrastruktury pro funkce a validátory v knihovně `SimpleException`. 
Sjednocuje dílčí kontroly chování kódu na validních i nevalidních vstupech do jedné sekvenční pipeline.

> 💡 Obsah:
> - [⚙️ Architektonické principy](#-architektonické-principy)
> - [🧭 Pipeline kroků](#-pipeline-kroků)
> - [🔍 Rychlé příklady použití](#-rychlé-příklady-použití)
> - [🛠️ Konfigurace a parametry](#-konfigurace-a-parametry)
> - [🔄 Průběh auditní pipeline (4 Fáze)](#-průběh-auditní-pipeline-4-fáze)
>   - [Fáze 1: Izolační brána volatelnosti](#-fáze-1-izolační-brána-volatelnosti)
>   - [Fáze 2: Kontrola čistého průchodu (Happy Path)](#-fáze-2-kontrola-čistého-průchodu-happy-path)
>   - [Fáze 3: Záchyt negativního stavu a kontrola typu chyby](#-fáze-3-záchyt-negativního-stavu-a-kontrola-typu-chyby)
>   - [Fáze 4: Hloubkový audit telemetrických polí](#-fáze-4-hloubkový-audit-telemetrických-polí-při-deep_checktrue)
> - [📖 Příklady použití v praxi (Kuchařka)](#-příklady-použití-v-praxi-kuchařka)
>   - [Případ 1: Jednoduché testování čistě negativního scénáře](#-případ-1-jednoduché-testování-čistě-negativního-scénáře)
>   - [Případ 2: Parametrizovaný test s kontrolou Happy Path](#-případ-2-parametrizovaný-test-s-kontrolou-happy-path-valid_params)
>   - [Případ 3: Izolované testování pozitivních průchodů](#-případ-3-izolované-testování-pozitivních-průchodů-a-oddělený-záchyt)
