...
from simplibs.exception.core._exception_mixins.dunders.utils.check_children_class_attributes import check_children_class_attributes
...
def test_unknown_attribute_raises():
    ...
    # Verification that the list of unknown keys is in the exception data
...
def test_unknown_attribute_context_contains_missing_parent_attrs():
    ...
    # The context should contain a hint about what remained in the parent (name)
